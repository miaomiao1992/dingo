...
Write your analysis to: `ai-docs/sessions/20251118-153544/output/{model-name}-analysis.md`

Return to main chat (MAX 5 sentences):
- Top recommendation (which approach?)
- Key insight or surprising finding
- Biggest risk/concern
- File path to full analysis

**Be thorough. Investigate real projects, read source code if needed, check GitHub discussions.**
